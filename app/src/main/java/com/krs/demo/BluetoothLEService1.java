...
public class BluetoothLEService1 extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "com.krs.smart.ACTION_GATT_CONNECTED_1";
    public final static String ACTION_GATT_DISCONNECTED = "com.krs.smart.ACTION_GATT_DISCONNECTED_1";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.krs.smart.le.ACTION_GATT_SERVICES_DISCOVERED_1";
    public final static String ACTION_DATA_AVAILABLE = "com.krs.smart.ACTION_DATA_AVAILABLE_1";
    public final static String EXTRA_DATA = "com.krs.smart.le.EXTRA_DATA_1";
    ...
    private BluetoothGattCallback bluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                Toast.makeText(BluetoothLEService1.this, "Write " + status, Toast.LENGTH_LONG).show();
            }
        }
